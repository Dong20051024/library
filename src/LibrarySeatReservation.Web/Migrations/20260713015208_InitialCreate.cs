        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Facilities = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, defaultValue: ""),
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Reservation",
                columns: new[] { "SeatId", "StartTime", "EndTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservation_StudentName",
                table: "Reservation",
                column: "StudentName");

            migrationBuilder.CreateIndex(
                name: "UQ_Seat_Floor_Area_SeatNumber",
                table: "Seat",
                columns: new[] { "Floor", "Area", "SeatNumber" },
                unique: true);
        }
